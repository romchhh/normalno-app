      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-14">
        <div className="flex items-end justify-between mb-6">
          <div>
            ...
            <p className="section-subtitle">Широкий вибір автомобілів з США</p>
          </div>
          ...
          {[
            {
              ...
              text: "Ретельна перевірка кожного авто перед доставкою",
            ...
            },
            {
              ...
              text: "Супровід на кожному етапі логістики",
